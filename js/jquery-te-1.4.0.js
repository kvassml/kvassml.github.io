...
(function($){		
	$.fn.jqte = function(options){
		...
		return this.each(function(){
			...
			// insert toolbar in jqte editor - вставить панель инструментов в редакторе jqte
			...
			// add to some tools in link form area - добавить в некоторые инструменты в области формы ссылки
			...
			// add to the link-type-selector sub tool parts - добавить к вспомогательным частям инструмента выбора типа ссылки
			...
			// create to the source-area - создать в исходной области
			...
			// move the element to the source-area -переместить элемент в исходную область
